...
<div class="bg-color-5 p-10 rounded-xl shadow-lg w-full max-w-4xl border border-color-3 mx-auto mt-16">
    ...
    <input type="text" name="egresado[carrera]" value="<?= $egresado->carrera ?>" required>
        </div>
        <div class="flex flex-col">
            <label class="mb-1 text-color-2 font-semibold">Año de Egreso</label>
    <input type="number" name="egresado[anio_egreso]" value="<?= $egresado->anio_egreso ?>" required>
        </div>
