...
<head>
    ...
    <title>Editar Empresa - Administrador</title>
...
<div class="bg-color-5 p-10 rounded-xl shadow-lg w-full max-w-5xl border border-color-3 mx-auto mt-16">
    <h1 class="text-3xl font-bold mb-8 text-center text-color-1">Editar Empresa</h1>
<form action="" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="empresa[id_empresa]" value="<?= $empresa->id_empresa ?? '' ?>">
        ...
        <div>
            ...
            <select id="id_representante" name="empresa[id_representante]" required
                ...
                <?php foreach ($usuario as $u): ?>
                    <option value="<?= $u['id_usuario'] ?>" <?= $empresa->id_representante == $u['id_usuario'] ? 'selected' : '' ?>>
