...
<form action="" method="POST">
            ...
            <select id="id_convocatoria" name="postulacion[id_convocatoria]" required
                ...
                <?php foreach ($convocatoria as $c): ?>
                    <option value="<?= $c['id_convocatoria'] ?>"
                        <?= ($postulacion->id_convocatoria == $c['id_convocatoria']) ? 'selected' : '' ?>>
                        <?= $c['titulo'] ?>
                    </option>
                <?php endforeach; ?>
            </select>
            ...
            <select id="id_usuario" name="postulacion[id_usuario]" required
                ...
                <?php foreach ($usuario as $u): ?>
                    <option value="<?= $u['id_usuario'] ?>"
                        <?= ($postulacion->id_usuario == $u['id_usuario']) ? 'selected' : '' ?>>
                        <?= $u['nombre'] . ' ' . $u['apellido'] ?>
                    </option>
                <?php endforeach; ?>
            </select>
    ...
    <select id="estado" name="postulacion[estado]" required
        ...
        <?php 
            ...
            $estadoActual = isset($postulacion->estado) ? (string)$postulacion->estado->value : '';
